...
class CareGiverRegisterUseCase extends BaseUseCase<UserEntity , Map<String , dynamic>>
{
  final AuthBaseRepository authBaseRepository;

  CareGiverRegisterUseCase(this.authBaseRepository);

  @override
  Future<Either<Failure, UserEntity>> call(Map<String, dynamic> parameters)async
  {
    return await authBaseRepository.careGiverRegister(parameters);
  }
}