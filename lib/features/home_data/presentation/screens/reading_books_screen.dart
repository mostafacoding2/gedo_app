                ...
                children: [
                  PositionedDirectional(
                      ...
                      child: SizedBox(
                        width: 170.w,
                        height: 190.h,
                        child: SvgPicture.asset(ImagesPath.Reboot),
                      )),
                  PositionedDirectional(
                      top: 85.r,
                      start: 153.r,
                      child: SizedBox(
                          width: 180.w,
                          height: 210.h,
                          child: SvgPicture.asset(ImagesPath.cloudy))),
                  PositionedDirectional(
                    top: 139.h,
                    start: 181.r,
                    child: Text("""  أنا روبوت ذكاء إصطناعي 
...
واضحه """,
                  ...
                  PositionedDirectional(
                    ...
                    child: Text("""سوف يساعدك في تلقي الاشياء المكتوبة 
...
توضيح و تكبير الخطوط """,
                  ...
                  Padding(
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        navigateAndRemove(
                            context, const DirectionReadingBooksScreen());
                      },
                    ),
                  ),
                ],
