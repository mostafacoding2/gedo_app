...
import 'package:alzcare/features/home_data/presentation/widgets/Item_skin_deseases_diseases.dart';
...
class ListviewResultSkinDeseasesScreen extends StatelessWidget {
  const ListviewResultSkinDeseasesScreen({super.key});
    ...
    return SafeArea(
      child: Scaffold(
        ...
        const CustomAppBarTextAndArrowWidget(
          ...
          //ToDo:
          // widgetnavigate: ResultDiagnosisSkinDesiesrScreen(),
        ),
        Expanded(
          ...
          Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return const ItemSkinDeseasesDiseases();
                  })),
          CustomAddAnalysisdetailsPrescription(
            onTap: () {
              ...
              // navigateAndRemove(
              //     context, const CameraDiagnosisSkinDesiesDiseasesScreen());
            },
          ),
