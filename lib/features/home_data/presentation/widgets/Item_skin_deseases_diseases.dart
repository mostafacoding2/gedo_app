...
class ItemSkinDeseasesDiseases extends StatelessWidget {
  const ItemSkinDeseasesDiseases({super.key, });
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,
              children:
              [
                Text('الصدفية',style: lightTheme.textTheme.displayMedium!.apply(
                  fontSizeFactor: 1.sp,
                  color: AppColors.dark,
                ),),
//
