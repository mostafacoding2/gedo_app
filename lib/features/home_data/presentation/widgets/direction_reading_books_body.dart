...
import 'package:alzcare/features/home_data/presentation/screens/camera_reading_books_screen.dart';
...
class DirectionsReadingBooksBody extends StatelessWidget {
  const DirectionsReadingBooksBody({super.key});
  @override
        ...
        child:Column(
          children: [
            ...
            Container(
                ...
                width:140.h,height:230.h,child: SvgPicture.asset(ImagesPath.backgroundcontentview))
              ...
              child: Column(
                children: [
                  ...
                  Row(children: [
                    Icon(Icons.circle,color: AppColors.lightprimaryColor,size: 16.r,),
                    SizedBox(width: 2.w,),
                    Text('يمكنك أستخدام هذه الميزه لقراءة أياً من الأشياء صوتياً',style: Theme.of(context).textTheme.headlineLarge!.apply(
                      fontSizeFactor: 1.1.sp,
                      color: AppColors.dark,
                    ),),
                  ],),
                  ...
                  Row(children: [
                    Icon(Icons.circle,color: AppColors.lightprimaryColor,size: 16.r,),
                    SizedBox(width: 2.w,),
                    Text('يُسهل عليك قراءة الكتب بطريقه واضحه و ايضاً تكبير الخط',style: Theme.of(context).textTheme.headlineLarge!.apply(
                      fontSizeFactor: 1.1.sp,
                      color: AppColors.dark,
                    ),),
                  ],),
                  ...
                  CustomButton(
                    text: "next",
                    onPressed: () {
                    navigateTo(context, CameraReadingBooksScreen());
                    },
                  ),
